...
\begin{titlepage}
    \begin{center}
        ...
        \includegraphics[width=0.4\textwidth]{${COMPLEXITY_CHART}}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{${COMPLEXITY_CHART}}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{${MAINTAINABILITY_CHART}}
